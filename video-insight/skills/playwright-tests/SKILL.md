...
allowed-tools: mcp__video-understanding__generate_tests
...
1. Call MCP tool `mcp__video-understanding__generate_tests` with `video_path` = `$0` and `framework` = `"playwright"`.
